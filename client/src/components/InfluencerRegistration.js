...
function InfluencerRegistration()
{
    ...
    return (
        <div className="flex rounded-3xl mx-48 mt-16">
            ...
            <div className = "bg-purple-300 rounded-l-3xl  w-2/5 h-[550px]">
            <form onSubmit={handleRegistration}>
                ...
                name = 'username'
                id = 'username'
                className = "md:ml-16 rounded-xl bg-purple-200 w-48 py-2 px-2 border-none outline-none md:mt-24"
                spellcheck="false"
                value = {username}
                required
                ...
                name = 'password'
                id = 'password'
                className = "md:ml-16 rounded-xl bg-purple-200 w-48 py-2 px-2 border-none outline-none md:mt-7"
                spellcheck="false"
                value = {password}
                required
    
                />
                <textarea placeholder="Bio" value={bio} onChange={(e) => setBio(e.target.value)} className = "md:ml-16 bg-purple-200 py-2 px-2 w-48 border-none rounded-xl outline-none md:mt-7" required />
                <input type="number" placeholder="Age" value={age} onChange={(e) => setAge(e.target.value)} className = "md:ml-16 w-48 bg-purple-200 py-2 px-2 rounded-xl border-none outline-none md:mt-7" required />
